...
\resumeItemListStart
  ...
  \resumeItem{}{Built an unsupervised deep-learning autoencoder for sensor anomaly detection, flagging faults missed by rule-based checks at about a 3\% false-positive rate and preserving data quality for downstream modeling.}

  \resumeItem{}{Established a systematic methodology to characterize baseline (normal) sensor behavior, defining the reference that the downstream defect-detection models are trained and evaluated against.}
