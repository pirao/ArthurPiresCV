...
\resumeSubHeadingListStart
  ...
  {Technical Lead in Applied AI}{January 2022 to Present}
  \resumeItemListStart
...
\resumeItemListStart
  ...
  \resumeItem{}{Built a daily ETL pipeline processing 20,000 to 40,000 sensor records per asset per day, integrating multiple external sources into one analytical dataset that powered all downstream models.}

  \resumeItem{}{Reduced reliance on costly specialized inspections by predicting asset condition at $R^{2} \approx 0.98$ with deep learning models on sensor data.}
...
{Intern in Machine Learning and Optimization}{Jan 2019 to June 2020}
\resumeItemListStart

  \resumeItem{}{Estimated hard to measure contact forces at $R^{2} \approx 0.97$ from onboard sensors validated against simulation, making the company's predictive maintenance program viable.}

  \resumeItem{}{Lowered component wear by 20\% and improved a key safety ratio by roughly 35\% by optimizing wear profiles with genetic algorithms on field data.}

  \resumeItem{}{Drove a maintenance threshold change adopted into operations, projected to extend asset service life by 29\% to 50\%.}

\resumeItemListEnd
\resumeSkills{Python, MATLAB $\cdot$ Machine Learning (scikit-learn, Optuna) $\cdot$ Genetic Algorithms / Optimization $\cdot$ Multibody Simulation (Universal Mechanism, Simpack)}
