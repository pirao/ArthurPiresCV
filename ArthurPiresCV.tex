...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{}{Cut equipment failure detection latency from 3 months to real time at 91\% precision using deep learning models on multivariate sensor streams.}
...
\resumeItemListStart
  ...
  \resumeItem{}{Built an automated data-quality framework over the data pipeline that scores the reliability of each data-collection run and filters unreliable sensor data, replacing manual trip-by-trip screening.}

  \resumeItem{}{Developed an unsupervised deep learning autoencoder for sensor anomaly detection, flagging faults missed by rule-based checks at about a 3\% false-positive rate and preserving data quality for downstream modeling.}

  \resumeItem{}{Established a systematic methodology to characterize baseline sensor behavior, defining the reference against which the downstream defect-detection models are trained and evaluated.}
...
\resumeItemListStart
  ...
  \resumeItem{}{Built a Python ETL pipeline that processes 20,000-40,000 sensor records per asset per day, merging multiple raw data sources into a unified analytical dataset powering all downstream machine learning models.}
...
\resumeItemListStart
  ...
  \resumeItem{}{Optimized wheel/rail wear profiles with genetic algorithms, cutting wear 20\% and improving a key safety ratio by approximately 35\% without sacrificing fatigue performance.}
