...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{}{Liderou uma equipe de 12 pessoas entre cientistas de dados, pesquisadores e engenheiros, construindo sistemas de ML de manutenção preditiva de ponta a ponta para a VALE, dos requisitos das partes interessadas ao deploy escalável em produção.}
...
\resumeItemListStart
  ...
  \resumeItem{}{Projetou um framework automatizado de qualidade de dados que pontuava a confiabilidade de cada coleta e filtrava dados de sensores não confiáveis, substituindo a triagem manual feita viagem a viagem.}

  \resumeItem{}{Desenvolveu um autoencoder de deep learning não supervisionado que detectou anomalias em sensores não identificadas por verificações baseadas em regras, com cerca de 3\% de falsos positivos, preservando a qualidade dos dados para a modelagem posterior.}

  \resumeItem{}{Estabeleceu uma metodologia sistemática para caracterizar o comportamento normal dos sensores, aprimorando o treinamento e a avaliação dos modelos de detecção de defeitos subsequentes.}
...
\resumeItemListStart
  ...
  \resumeItem{}{Desenvolveu um pipeline de ETL em Python que processou entre 20 e 40 mil registros de sensores por ativo diariamente, integrando múltiplas fontes de dados em uma base analítica unificada que alimentou todos os modelos de Machine Learning subsequentes.}
  ...
  \resumeItem{}{Criou a base de dados e modelagem que sustentou iniciativas subsequentes de manutenção preditiva e detecção de defeitos de via na Vale.}
...
\resumeItemListStart
  ...
  \resumeItem{}{Estimou forças de contato difíceis de medir a partir de sensores embarcados usando um pipeline de ML validado por simulação, alcançando um R2 de cerca de 0,97, cujos resultados ajudaram a motivar a decisão da VALE de lançar um projeto de P\&D dedicado à manutenção preditiva de via usando vagões instrumentados.}
