...
\resumeSubHeadingListStart
  ...
  {Líder Técnico em IA Aplicada}{Janeiro 2022 até o presente}
  \resumeItemListStart
...
\resumeItemListStart
  ...
  \resumeItem{}{Reduziu a dependência de inspeções especializadas custosas ao prever a condição do ativo com $R^{2} \approx 0{,}98$ via deep learning sobre dados de sensores.}
...
{Estagiário em Machine Learning e Otimização}{Jan 2019 a Junho 2020}
\resumeItemListStart

  \resumeItem{}{Estimou forças de contato difíceis de medir com $R^{2} \approx 0{,}97$ a partir de sensores embarcados validados contra simulação, viabilizando o programa de manutenção preditiva da empresa.}

  \resumeItem{}{Reduziu o desgaste de componentes em 20\% e melhorou uma relação de segurança chave em cerca de 35\% ao otimizar perfis de desgaste com algoritmos genéticos e dados de campo.}

  \resumeItem{}{Conduziu uma mudança no limite de manutenção adotada na operação, com projeção de aumento de vida útil do ativo de 29\% a 50\%.}

\resumeItemListEnd
\resumeSkills{Python, MATLAB $\cdot$ Machine Learning (scikit-learn, Optuna) $\cdot$ Algoritmos Genéticos / Otimização $\cdot$ Simulação Multicorpos (Universal Mechanism, Simpack)}
