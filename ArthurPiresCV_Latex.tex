  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{ML Pipeline: }
          {Designed and operated a daily pipeline to ingest raw instrumented railway vehicle (IRV) data, engineer features, and generate model-ready windows for sensor-fault and track-defect detection (30k+ windows/day); maintained the codebase in Git and reviewed outputs with maintenance engineers.}
...
\section{Skills Summary}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{ML Domains}{~~Time-series modeling, anomaly detection, predictive maintenance}
